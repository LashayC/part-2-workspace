...
public class WildcardTest {
   ...
   */
  private double sum(Collection<? extends Number> values) { //NOTE it says that anything that extends number can be used here. Therefore double extends number and it workds.
    double sum = 0.0;
