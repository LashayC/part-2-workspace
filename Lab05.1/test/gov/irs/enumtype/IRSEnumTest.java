...
public class IRSEnumTest {
  ...
  public void testSingleton() {
    IRS irs1 = IRS.getInstance();//NOTE even though enums are public by default, still good policy to use a getter(looks more like a singleton)
  ...
  public void testClassLoading() {
    ...
    //IRSEnum.touch(); //NOTE shows that when you invoke any method on an enum, the class automatically gets loaded into memory. (Even if method static). BC its being instantiated on load, thats eager loading.
