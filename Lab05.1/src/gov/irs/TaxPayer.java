...
public interface TaxPayer {
  ...
  public static final double SALARIED_TAX_RATE = 0.30; //NOTE Grayed out bc any field in interface is public static final by default
  
  public double payTaxes(); //NOTE Concrete abstract methods in a field are all that can be private in an interface.
}