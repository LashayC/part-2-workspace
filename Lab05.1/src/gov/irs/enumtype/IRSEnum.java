...
public enum IRSEnum implements IRS{
  INSTANCE; //NOTE has a single enumberable value (which makes it a singleton ). Since enums are public by default you can use an interface to encapsulate this from the user. - enums can implement interfaces! Look at IRS.java
