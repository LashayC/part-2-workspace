...
public class EmployeeFactoryTest {
   ...
   */
  @Test
  public void testCreateEmployeeSalaried() { //NOTE when testing constructors, there will be mult tests inside bc you want to test for each value. type, name etc.(This is just mult assertions to test if one method is working, NOT mult tests types)
    // TODO
    SalariedEmployee emp = (SalariedEmployee) EmployeeFactory.createEmployee(seMap); //NOTE: You need to cast Salaried Employee because the Employee class doesn't have .getSalary() method
   ...
   */
  @Test(expected = IllegalArgumentException.class)//NOTE: Every type has a static method called class containing metadata. You can't just drop an exception here alone?
